...
<table id="info">
  <tr>
    ...
    <td><a href="client://%%CLIENT_ID%%/%%CLIENT_UNIQUE_ID%%~%%CLIENT_NAME_PERCENT_ENCODED%%" style="text-decoration: underline; color: red;">%%CLIENT_NAME%%</a><tdseperator> | </tdseperator><tdh>Client Version:</tdh> v%%CLIENT_VERSION_SHORT%% (%%CLIENT_PLATFORM%%)</td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td><orangeinfo>%%CLIENT_TOTALCONNECTIONS%%</orangeinfo> connections to this server.<tdseperator> | </tdseperator><tdh>First Connection:</tdh> %%CLIENT_CREATED%%</td>
  </tr>
  <tr>
    <td class="label">Online For:</td>
